...
Read `references/manager-runbook.md` for concrete routing decisions across the current agent estate.
...
- `references/manager-runbook.md` — concrete routing/playbook guidance for real task families
